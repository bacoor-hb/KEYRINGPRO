...
export const AFFILIATE_FEE_PERENT = 0
...
export const KEY_STORE_ID = {
  SERVICE_MORILIS_API_KEY: 'SERVICE_MORILIS_API_KEY',
  SERVICE_QUICKNODE_API_KEY: 'SERVICE_QUICKNODE_API_KEY',
  SECURE_STORAGE_DEFAULT_ENCRYPTION_KEY: 'SECURE_STORAGE_DEFAULT_ENCRYPTION_KEY',
  KEYRING_HARDWALLET_WEB_NFC_SALT: 'KEYRING_HARDWALLET_WEB_NFC_SALT',
  CUSTOM_AUTH_FOR_LAYER_API: 'CUSTOM_AUTH_FOR_LAYER_API',
  PASSWORD_NFC_ONE: 'PASSWORD_NFC_ONE',
  PASSWORD_NFC_TWO: 'PASSWORD_NFC_TWO',
  PASSWORD_NFC_THREE: 'PASSWORD_NFC_THREE',
  PASSWORD_NFC_FOUR: 'PASSWORD_NFC_FOUR',
  RELAY_API_KEY: 'RELAY_API_KEY',
  KEYCHAIN_PASSWORD_ENCRYPTION_KEY: 'KEYCHAIN_PASSWORD_ENCRYPTION_KEY',
  AGENT_CORE_SECRET_KEY: 'AGENT_CORE_SECRET_KEY',
  AGENT_CORE_GEMINI_API_KEY: 'AGENT_CORE_GEMINI_API_KEY',
  DEBRIDGE_ACCESS_TOKEN: 'DEBRIDGE_ACCESS_TOKEN',
  SERVICE_CHATWORK_API_TOKEN: 'SERVICE_CHATWORK_API_TOKEN',
  SERVICE_CHATWORK_ROOM_ID: 'SERVICE_CHATWORK_ROOM_ID',
